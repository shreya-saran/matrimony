      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-10">
        ...
        <div>
          <div className="flex items-center gap-3 mb-3">
            <img
              src={logo}
              alt="Elite Matrimony Breaue"
              className="w-12 h-12 rounded-full object-contain"
            />
            <h2 className="text-2xl font-bold text-teal-700">Elite Matrimony</h2>
          </div>
        ...
        {/* Quick Links (working anchors for internal sections) */}
        <div>
          <h3 className="text-lg font-semibold text-teal-700 mb-3">Quick Links</h3>
          <ul className="space-y-2">
            ...
            <li>
              <a href="#success" className="hover:text-pink-600 transition-colors">
                Success Stories
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#clients" className="hover:text-pink-600 transition-colors">
                Clients
              </a>
            </li>
            <li>
            ...
            <li>
              {/* privacy is a separate page / route */}
